...
public class StudentMarkSheet {
	...
	public int getSem1Total(int x) {
		return sem1Total;
	}
	public int setSem1Total(int sem1Total) {
		return this.sem1Total = sem1Total;
	}
	public int getSem2Total(int y) {
		return sem2Total;
	}
	public int setSem2Total(int sem2Total) {
		return this.sem2Total = sem2Total;
	}
